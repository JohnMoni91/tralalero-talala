...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active" align='center'>
      <img class='imagem' class="d-block w-10" src="assets/img1.png" alt="First slide">
    </div>

    <div class="carousel-item" align='center'>
      <img class='imagem' class="d-block w-10" src="assets/img2.png" alt="Second slide">
    </div>

    <div class="carousel-item" align='center'>
      <img class='imagem' class="d-block w-10" src="assets/img3.png" alt="Third slide">
    </div>
